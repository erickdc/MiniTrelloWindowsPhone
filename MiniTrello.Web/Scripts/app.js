    ...
    .config(['$stateProvider', '$locationProvider', '$httpProvider', function ($stateProvider, $locationProvider, $httpProvider) {
        ...
        $stateProvider
            ...
            .state('updateInformation', {
                ...
                templateUrl: '/views/updateInformation',
                controller: 'AccountController'
            })
            .state('organizations', {
                url: '/organizations',
             ...
             .state('createOrganization', {
                 ...
                 templateUrl: '/views/createOrganization',
                 controller: 'OrganizationController'
             })
            
            .state('recoverPassword', {
                url: '/recoverPassword',
                templateUrl: '/views/recoverPassword',
                controller: 'AccountController'
            })
            ...
            .state('crearLane', {
                url: '/boards/:boardId/lanes/crearLanes',
                templateUrl: '/views/crearLane',
                controller: 'LaneController'
            })

             .state('crearBoard', {
                 url: '/organizations/:organizationId/boards/crearBoard',
                 templateUrl: '/views/crearBoard',
                 controller: 'BoardController'
             })
